...
parser MyParser(packet_in packet, /*the hardware provide this implementation */
                out headers hdr,
                inout metadata meta,/* tt: user defined data format */
                inout standard_metadata_t standard_metadata /*tt: data format from v1model.p4 */) {
